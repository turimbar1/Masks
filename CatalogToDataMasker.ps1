...
$serverUrl = "http://us-lt-andrewp:15156" # or https:// if you've configured SSL
...
$inputMaskingSetPath = "WidgetDev.DMSMaskSet"
$outputMaskingSetPath = "WidgetDev Generated.DMSMaskSet"
